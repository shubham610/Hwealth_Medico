        ...
        <div class="flex h-full w-2/3  bg-white shadow-xl">
          <div class="flex-1 overflow-y-auto px-4 py-6 smx-6 nav-hidden" >
            <div class="flex items-start justify-between">
              <h1 class="text-2xl font-medium text-gray-900" id="slide-over-title">Shopping cart</h1>
            ...
            <div class="mt-8 h-80">
              <div class="flow-root">
                ...
                {cartContext.cartItems?cart.map(
                        item=>{return <li class="flex py-6">
                        ...
                        <div class="ml-4 flex flex-1 flex-col">
                          ...
                          <div class="flex gap-6">
                            ...
                            <div class="relative flex items-center">
                              ...
                              <input disabled type="text" id="counter-input" data-input-counter class="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus￼utline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder=""    required></input>
                        ...
                        ):<div class="flex justify-center items-center"><img className=' size-1/2' src='https://www.adasglobal.com/img/empty-cart.png'/>
                        </div>}
                  {/* <!-- More products... --> */}
                </ul>
              </div>
        ...
        <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
          <div class="rounded-2xl bg-gray-50 py-10 ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lgy-16 px-6">
            ...
            <div class="flex  border-b py-1 justify-between max-w-xs">
              ...
              <p class="mt-6 text-base leading-5 text-gray-600">$99.00</p>

            </div>
            <div class="flex border-b py-1 justify-between max-w-xs">
              <p class="mt-6 text-base text-gray-600">Shipping Estimate</p>

              <p class="mt-6 text-base leading-5 text-gray-600">$5.00</p>

            </div>
            <div class="flex border-b py-1 justify-between max-w-xs">
              <p class="mt-6 text-base text-gray-600">Tax Estimate</p>

              <p class="mt-6 text-base leading-5 text-gray-600">$8.32</p>

            </div>
            <div class="flex text-lg font-medium py-1 justify-between max-w-xs">
              <p class="mt-6 text-gray-900">Order Total</p>

              <p class="mt-6 leading-5 text-gray-900">$112.32</p>

            </div>
            <div class="mt-6">
              <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-cyan-700 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-cyan-800">Proceed</a>
            </div>
