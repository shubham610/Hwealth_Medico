...
const Cart = () => {
  ...
  const proceed=async()=>{
    ...
    try {
      const response=await axios.post("http://localhost:8080/order/add",order);
...
{ !showCart&&     <div className="w-[75%] m-auto">
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
      <div class="sm:col-span-3">
        <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">First name</label>
        <div class="mt-2">
          <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input type="text" name="last-name" id="last-name" autocomplete="family-name" class=" pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>

      <div class="sm:col-span-4">
        <label for="PhoneNo" class="block text-sm font-medium leading-6 text-gray-900">Phone No. </label>
        <div class="mt-2">
          <input id="PhoneNo" onChange={(e)=>setphoneno(e.target.value)} name="PhoneNo" type="number"  class=" pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <select id="country" onChange={(e)=>setcountry(e.target.value)} name="country" autocomplete="country-name" class="block w-full outline-none rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:max-w-xs sm:text-sm sm:leading-6">
      ...
      <div class="col-span-full">
        ...
        <div class="mt-2">
          <input type="text" onChange={(e)=>setfullAddress(e.target.value)} name="street-address" id="street-address" autocomplete="street-address" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
      ...
      <div class="sm:col-span-2 sm:col-start-1">
        ...
        <div class="mt-2">
          <input type="text" onChange={(e)=>setcity(e.target.value)} name="city" id="city" autocomplete="address-level2" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-2">
          <input type="text" onChange={(e)=>setstate(e.target.value)} name="region" id="region" autocomplete="address-level1" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-2">
          <input type="text" onChange={(e)=>setpinCode(e.target.value)} name="postal-code" id="postal-code" autocomplete="postal-code" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6">
              </input>
        </div>
      </div>
